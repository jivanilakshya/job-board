        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/employers" className="text-gray-400 hover:text-white transition duration-300">
                  For Employers
                </Link>
              </li>
              <li>
                <Link to="/candidates" className="text-gray-400 hover:text-white transition duration-300">
                  For Candidates
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/help-center" className="text-gray-400 hover:text-white transition duration-300">
                  Help Center
                </Link>
              </li>
              <li>
